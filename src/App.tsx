    ...
    <div className="wrapper">
      ...
      <div className="container-col flex-[30%]">
        ...
        <div className="container-col border border-solid border-grey-400 rounded-lg mt-3 p-[12px] pl-[12px]">
          <div className="container-row justify-start border border-solid border-grey-400 rounded-lg">
          ...
          <button onClick={addTask} className="w-full mt-[10px] p-[5px] bg-color_blue rounded text-white">Add new task</button>
        </div>
      </div>
      ...
      <div className="container-col flex-[70%]">
        ...
        <div className="container-col my-[7px]">
          <div className="container-row justify-between gap-[10px]">
            <button className="p-[7px] px-[95px] bg-color_blue rounded text-white">All</button>
            <button className="p-[7px] px-[95px] bg-color_blue rounded text-white">Done</button>
            <button className="p-[7px] px-[95px] bg-color_blue rounded text-white">Todo</button>
          </div>
          <div className="w-full my-[40px] h-[240px] max-h-[240px] overflow-y-scroll">
            {todoList.map((task: ITask) => <TodoTask key={task.id} task={task}/>)}
          </div>
          <div className="container-row justify-between">
            <button className="p-[7px] px-[115px] bg-color_red rounded text-white">Delete done tasks</button>
            <button className="p-[7px] px-[115px] bg-color_red rounded text-white">Delete all tasks</button>
          </div>
        </div>
      </div>
    </div>
